			...
			<div id="melhoresCat" class="row">
				<?php 
					foreach($filmes as &$filme){
						...
						$ano = $filme['anoFilme'];
						echo "<div class='content'><div class='filme-content'><a href='".$link."' target='_blank'><img class='filme-image' src='images/".$capa."'></a><div class='filme-nome'>".$titulo."</div><span class='filme-nota'>".$nota."/10</span><span class='filme-ano'>".$ano."</span></div></div><div class='filme-more'><div class='material-symbols-outlined'>expand_more</div></div>";
