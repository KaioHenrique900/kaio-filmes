...
function getFilmes($gen){
	...
	$query = pg_query($conn, 'SELECT * FROM filmes as f inner join filmes_categorias as fc on f."idFilme" = fc."fk_idFilme" and fc."fk_idCat" = '.$gen.' order by f."tituloFilme"');
	$filmes = Array();
...
function getMelhores(){
	...
	$query = pg_query($conn, 'SELECT * FROM filmes as f inner join filmes_categorias as fc on f."idFilme" = fc."fk_idFilme" and fc."fk_idCat" = 14 order by f."tituloFilme"');
	$filmes = Array();
...
function getAnimacoes(){
	...
	$query = pg_query($conn, 'SELECT * FROM filmes as f inner join filmes_categorias as fc on f."idFilme" = fc."fk_idFilme" and fc."fk_idCat" = 2');
	$filmes = Array();
...
function getComedias(){
	...
	$query = pg_query($conn, 'SELECT * FROM filmes as f inner join filmes_categorias as fc on f."idFilme" = fc."fk_idFilme" and fc."fk_idCat" = 4');
	$filmes = Array();
...
function getDramas(){
	...
	$query = pg_query($conn, 'SELECT * FROM filmes as f inner join filmes_categorias as fc on f."idFilme" = fc."fk_idFilme" and fc."fk_idCat" = 5');
	$filmes = Array();
